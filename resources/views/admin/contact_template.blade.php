    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-12 form-group row">
            <div class="col-sm-6">{{ Form::text('hi_surname', old('hi_surname'), ['class' => 'form-control', 'id' =>
              'hi_surname']) }}</div>
            <div class="col-sm-6">{{ Form::text('hi_lastname', old('hi_lastname'), ['class' => 'form-control', 'id' =>
              'hi_lastname']) }}</div>
          </div>
