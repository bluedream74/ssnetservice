...
class SendEmails7Command extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:emails7';
    ...
    public function handle()
    {
        ...
        if( $startTimeCheck && $endTimeCheck ){
            ...
            foreach ($contacts as $contact) {
                ...
                if($startCheck) {
                    try{
                        $companyContacts = $contact->companies()->where('is_delivered', 0)->skip(6*$offset)->take($ex_numbers)->get();
